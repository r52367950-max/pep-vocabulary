...
const covers = readdirSync('public/images').filter(name=>/^reading-(essay|fiction|science)-(480|960)\.webp$/.test(name)).map(name=>({name,bytes:statSync(`public/images/${name}`).size}));
