...
[2.3.0](docs/RELEASE_2.3.0.md) 做了性能优化、代码精简、安全加固和无障碍修复，详见[优化报告](docs/OPTIMIZATION_REPORT_2.3.0.md)。[2.2.1](docs/RELEASE_2.2.1.md) 换用新的应用图标。[2.2.0 更新](docs/RELEASE_2.2.0.md)把插画改为程序实时生成（今日页青绿山水随时间变化，阅读封面按分类用水墨、剪纸、海流），新增词卡速记、配对消除、单元自测三种记单词方式，并统一了图标与动效。主要功能见 [2.1.0 发布说明](docs/RELEASE_2.1.0.md)：60 篇可阅读内容、个人文章导入与扫描、独立设置浮层、iPad 布局与手绘分类封面。
